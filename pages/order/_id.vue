    ...
    <table class="GoodList">
      <tbody>
        ...
        <tr class="good">
          ...
          <td class="priceNew Last">￥<strong style="text-decoration:line-through;">{{ order.totalFee/100 }}</strong> <strong style="color:red">¥0</strong><p>促销</p></td>
        </tr>
      </tbody>
    </table>
    <div class="Finish">
...
export default {
  ...
  methods: {
    ...
    toPay() {
      if (this.agree) {
        orderApi.finishPay(this.$route.params.id).then(res => {
